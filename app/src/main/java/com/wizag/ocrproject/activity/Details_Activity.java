...
public class Details_Activity extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mResultType == null) {
            throw new IllegalStateException("Results must be passed to Details_Activity!");
        }
...
//
                    ...
                    Toast.makeText(this, scannedPrimaryId, Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(this, ""+mFieldByFieldBundle, Toast.LENGTH_SHORT).show();
    ...
    private class FieldByFieldBundleFragmentAdapter extends FragmentPagerAdapter {
        ...
        @Override
        public CharSequence getPageTitle(int position) {
            return com.microblink.result.Details_Activity.this.getString(R.string.title_field_by_field_results);
        }
